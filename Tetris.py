...
def draw_text_middle(text, size, color, surface):
    font = pygame.font.SysFont(fontpath, size, bold=False, italic=True) #changed font.Font to font.SysFont
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    font = pygame.font.SysFont(fontpath_mario, 65, bold=True) #changed font.Font to font.SysFont
